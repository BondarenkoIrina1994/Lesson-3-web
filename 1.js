...
function temperatureFahrenheit(degree) {
    return Math.round(((9 / 5) * degree + 32) * 100) / 100;
}

const temperatureCelsius = Number.parseFloat(prompt("Введите температуру в градусах Цельсия"));
alert(`Температура в градусах Цельсия: ${temperatureCelsius}°C,
Температура в градусах по Фаренгейту: ${temperatureFahrenheit(temperatureCelsius)}°F`);